...
class CommandRuntime:
    ...
    def _environment(self, route: Route, order: WorkOrder) -> dict[str, str]:
        ...
        env["IDOL_FLEET_ORDER"] = order.id
        env["IDOL_FLEET_TASK"] = order.task_id
        env["IDOL_FLEET_BASE_SHA"] = order.base_sha
